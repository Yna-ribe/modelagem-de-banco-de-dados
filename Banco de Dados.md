...
Planilhas soltas: Funcionário sem registro e cargo dentro do restaurante (sobrinho do dono) faz pedido do estoque em planilhas a parte, somando no final do mês os custos mensais de forma 
Sem cadastro: funcionários/clientes(promoção de aniversário);
Falta de controle de estoque;
Tempo de espera (mesas e entrega de delivery);
Falta de qualidade;
